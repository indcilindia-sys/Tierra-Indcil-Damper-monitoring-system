...
export default function App() {
  ...
  return <div className="shell" style={{ display: 'block' }}><main style={{ width: '100%', marginLeft: 0, marginRight: 'auto' }}>
    <header><div className="company-heading"><img src="/brand/indsil-logo.png" alt="Indsil logo"/><div><p className="eyebrow">OPERATIONS / DAMPER 01</p><h1>Indsil India private limited</h1><p className="muted">Damper monitoring · Live operational status and runtime intelligence</p></div></div><div className="header-actions"><span className="updated">● Updated automatically</span><button className="secondary" onClick={load}><RefreshCw size={16}/> Refresh</button><button className="primary" onClick={() => downloadReport(report)}><Download size={16}/> Print PDF</button></div></header>
